...
public abstract class AbstractLifeCycle implements LifeCycle{
    ...
    protected final CopyOnWriteArrayList<LifeCycle.Listener> listeners = new CopyOnWriteArrayList<LifeCycle.Listener>();
    ...
    private static abstract class AbstractLifeCycleListener implements LifeCycle.Listener{
        @Override
