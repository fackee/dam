...
public class ReflectUtil {
    ...
    private static final  Map<String,Map<String,String>> getMethodParamsAnnotationValue(Method method){
        ...
        for(java.lang.reflect.Parameter parameter : parameters){
            ...
            try {
                if(parameter.getType().newInstance() instanceof com.dam.http.Request){
                    result.put("Request",new HashMap<>(0));
                }
                if(parameter.getType().newInstance() instanceof com.dam.http.Response){
